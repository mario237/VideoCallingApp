...
import com.mario.videocallingapp.network.ApiClient;
import com.mario.videocallingapp.network.ApiService;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    private void initiateMeeting(String meetingType, String receiverToken) {
        try {
            ...
            data.put(Constants.KET_FIRST_NAME, preferenceManager.getString(Constants.KET_FIRST_NAME));
            data.put(Constants.KEY_LAST_NAME, preferenceManager.getString(Constants.KEY_LAST_NAME));
            data.put(Constants.KET_EMAIL, preferenceManager.getString(Constants.KET_EMAIL));
    ...
    private void sendRemoteMessage(String remoteMessageBody, String type) {
        ApiClient.getClient().create(ApiService.class).sendRemoteMessage(
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable throwable) {
                Toast.makeText(OutgoingInvitationActivity.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
