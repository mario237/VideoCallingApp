...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String firstName = getIntent().getStringExtra(Constants.KET_FIRST_NAME);
        if (firstName != null) {
        ...
        textEmail.setText(getIntent().getStringExtra(Constants.KET_EMAIL));
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                if (response.isSuccessful()) {
                    if (type.equals(Constants.REMOTE_MSG_INVITATION_ACCEPTED)) {
                        ...
                        Toast.makeText(IncomingInvitationActivity.this, "Invitation is rejected", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
