package com.mario.videocallingapp.firebase;
...
import com.mario.videocallingapp.activities.IncomingInvitationActivity;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (type != null) {
            if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                ...
                intent.putExtra(
                        Constants.KET_FIRST_NAME,
                        remoteMessage.getData().get(Constants.KET_FIRST_NAME)
                );
                ...
                intent.putExtra(
                        Constants.KET_EMAIL,
                        remoteMessage.getData().get(Constants.KET_EMAIL)
                );
